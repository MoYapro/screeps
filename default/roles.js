...
const brawlerBody = () => [ATTACK, TOUGH, MOVE, MOVE];
 ...
 const roles = [];
  roles['harvester'] = {name: 'harvester', body: defaultBody, logic: roleHarvester, maxCount: 3};
  roles['upgrader'] = {name: 'upgrader', body: defaultBody, logic: roleUpgrader, maxCount: 2};
